...
const UserPrivacyPolicyScreenHeader = () => {
    ...
    return (
        <View style={styles.personalDetailsHeader}>
            <View style={styles.backIconHeader}>
                ...
                <View>
                    <Text style={styles.personText}>{strings.UserPrivacyPolicyScreen.privacyPolicy}</Text>
...
const UserPrivacyPolicyScreenMainContainer = () => {
    return (
