    ...
    return (
        <View style={styles.personalDetailsHeader}>
            <View style={styles.backIconHeader}>
                ...
                <Text style={styles.personText}>{strings.UserFeedbackandSuggessions.UserFeedbackandSuggessionsText}</Text>
            </View>
        </View>
    )
}
...
const UserContactSupportScreenBodyContainer = () => {
    ...
    return (
        <View >
            ...
            <Text style={styles.helpLogoText}>{strings.UserFeedbackandSuggessions.UserFeedbackandSuggessionsText}</Text>
            <Text style={styles.subTittle}>{strings.UserFeedbackandSuggessions.subTittle}</Text>
...
const UserFeedbackandSuggessions = () => {
    return (
...
export default UserFeedbackandSuggessions
